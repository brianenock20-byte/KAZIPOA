...
// Parallel custom-auth pilot session. This cookie is intentionally separate from
// the Manus OAuth session so the pilot can be feature-flagged and rolled back.
export const CUSTOM_AUTH_COOKIE = "kazipoa_custom_session";
