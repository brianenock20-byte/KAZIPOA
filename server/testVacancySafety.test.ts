...
import { TEST_VACANCY_BATCH_ID, TEST_VACANCY_LABEL, isTestVacancy, vacancyApplicationMode, vacancyApplicationUrl, vacancyCanBeIndexed, vacancyIsAuthorized } from "../shared/testVacancy";
